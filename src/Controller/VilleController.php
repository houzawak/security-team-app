...
class VilleController extends AbstractController
{
    ...
    /**
     * @Route("/{code}", name="ville_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{code}/edit", name="ville_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{code}", name="ville_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Ville $ville): Response
    {
        if ($this->isCsrfTokenValid('delete'.$ville->getCode(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
